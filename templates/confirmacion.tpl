...
<div class="container_confirmacion">
   <div class="row-fluid">
       <div class="container-titulo  col-lg-12">
           <h3 class="text-center alert alert-info">{#gracias#} {$reserva->usuario->nombre} {if $reserva->estatus eq 'Aprobada'}{#tu_reserva_esta_confirmada#}{else}{#tu_reserva_esta_siendo_procesada#}{/if}</h3>
       </div>
   </div>
   <div class="row-fluid">
            ...
            <div class="container-tarjeta">
               ...
               <li class="list-group-item">
                  ...
                  <div class="text-center">
                    <button id="cancelar_reserva_btn" reserva-codigo="{$reserva->codigo}" type="button" class="btn btn-primary">{#cancelar_reserva#}</button>
                  </div>
               </li>  
               </ul> 
            </div> 
...
<div class="col-lg-12">
       ...
       <li class="list-group-item">
      <img src="{$qrcodeurl}">
       <p> {#te_hemos_enviado_la_reserva_por_mail_a#}  <a href="mailto:{$reserva->usuario->email}">{$reserva->usuario->email}</a></p>
       <button codigo-reserva="{$reserva->codigo}" id="imprimir_reserva_btn" type="button" class="btn btn-primary">{#imprimir#}</button>
       </li>
       </ul>
       </div>
       </div>
