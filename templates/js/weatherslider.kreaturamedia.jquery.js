...
(function($) {
	...
	$.weatherSlider = function(el, options) {
		...
		ws.getWeather = function(id,search){
			...
			if( ws.o.ajaxURL ){
				...
				var obj = { action : 'weatherslider_getdata', location : l, service : 'weather' };
			}else{
			...
			$.getJSON(url, obj, function(d){
				...
				if( data['current_condition'] ){
					...
					if( ws.o.ajaxURL ){
						url = ws.o.ajaxURL;
						obj = { action : 'weatherslider_getdata', location : l, service : 'timezone' };
					}else{
	...
	$.weatherSlider.language = {
		...
		get					: 'Obteniendo tiempo',
		not					: 'Ubicación no encontrada',
		una					: 'Imposible encontrar tu ubicación actual.',
		search				: 'Ingrese su ubicación',
		...
		'122'				: 'Nublado',
		'143'				: 'Niebla',
		'176'				: 'Nubes y lluvia en las inmediaciones',
		'179'				: 'Nubes y nieve en las inmediaciones',
		'182'				: 'Nubes y aguanieve en las inmediaciones',
		'185'				: 'Nubes y llovizna helada cercana',
		'200'				: 'Truenos en las inmediaciones',
		'227'				: 'Ventisca de nieve',
		'230'				: 'Tormenta de nieve',
		'248'				: 'Neblina',
		'260'				: 'Niebla helada',
		'263'				: 'Patchy light drizzle',
		'266'				: 'Ligera lluvia irregular',
		'281'				: 'Llovizna helada',
		'284'				: 'Pesada llovizna helada',
		'293'				: 'Lluvia ligera irregular',
		'296'				: 'Lluvia ligera',
		'299'				: 'Lluvia moderada a veces',
		'302'				: 'Lluvia moderada',
		'305'				: 'Lluvia torrencial a veces',
		'308'				: 'Lluvia torrencial',
		'311'				: 'Lluvias heladas ligeras',
		'314'				: 'Lluvias heladas ligeras o moderadas',
		'317'				: 'Aguanieve ligera',
		'320'				: 'Aguanieve ligera o moderadas',
		'323'				: 'Nieve ligera irregular',
		'326'				: 'Nieve ligera',
		'329'				: 'Nieve moderada irregular',
		'332'				: 'Nieve moderada',
		'335'				: 'Nieve pesada irregular',
		'338'				: 'Nieve pesada',
		'350'				: 'Granizo',
		'353'				: 'Ducha de lluvia ligera',
		'356'				: 'Ducha de lluvia moderada',
		'359'				: 'Ducha de lluvia torrencial',
		'362'				: 'Light sleet showers',
		'365'				: 'Chubasco de aguanieve ligera',
		'368'				: 'Chubasco de nieve ligera',
		'371'				: 'Chubasco de nieve moderada',
		'374'				: 'Chubasco de granizo ligero',
		'377'				: 'Chubasco de granizo moderado',
		'386'				: 'Lluvia irregular con truenos en las inmediaciones',
		'389'				: 'Lluvia moderada con truenos en las inmediaciones',
		'392'				: 'Lluvia irregular ligera con truenos en las inmediaciones',
		'395'				: 'Nieve con truenos en las inmediaciones'		
	};
	...
	$.weatherSlider.options = {
		...
		imgPath				: BASE_URL+'/templates/imagenes/weatherslider/',
		...
		WWOAPIKey			: 'wb8wwjjzsj5zgndmvktrsbe8'
	};
